...
Project Link: [https://github.com/yourusername/identity-asset-dashboard](https://github.com/yourusername/identity-asset-dashboard)

---

**Built with ❤️ using React, CSS, and careful attention to detail.**

## 📸 Screenshots

### Light Mode
![Light Mode Dashboard](https://via.placeholder.com/800x450?text=Light+Mode+Dashboard)

### Dark Mode
![Dark Mode Dashboard](https://via.placeholder.com/800x450?text=Dark+Mode+Dashboard)

### Certificates Module
![Certificates](https://via.placeholder.com/800x450?text=Certificates+Module)

### SSH Keys with Expanded Row
![SSH Keys](https://via.placeholder.com/800x450?text=SSH+Keys+Module)

### Code Signing Keys - Grid View
![Code Signing Grid](https://via.placeholder.com/800x450?text=Grid+View)

### Audit Logs with JSON Metadata
![Audit Logs](https://via.placeholder.com/800x450?text=Audit+Logs)

## 🎓 Learning Resources

If you're interested in how this was built, check out:
...
![GitHub stars](https://img.shields.io/github/stars/yourusername/identity-asset-dashboard?style=social)
![GitHub forks](https://img.shields.io/github/forks/yourusername/identity-asset-dashboard?style=social)
![GitHub issues](https://img.shields.io/github/issues/yourusername/identity-asset-dashboard)
![GitHub pull requests](https://img.shields.io/github/issues-pr/yourusername/identity-asset-dashboard)

---

Made with passion for clean code and beautiful UIs 🚀
